...
DEFAULT_NAME_PREFIX = 'catena-staging'


@dataclass
class AwsNetCfg:
    vpc_name: str = 'Catena Staging' + ' VPC'
...
paipass_dir = os.getenv('CATENA_DIR', os.path.expanduser('~/catena'))

container_names = [
    'backend',
]

DEFAULT_AWS_NET_CFG = AwsNetCfg(subnets=({'name': f'{DEFAULT_NAME_PREFIX}-subnet-2a',
                                          'az': 'us-east-2a',
                                          'azid': 'use2-az1',
                                          'cidr_block': '10.0.1.0/24'},
                                         {'name': f'{DEFAULT_NAME_PREFIX}-subnet-2b',
                                          'az': 'us-east-2b',
                                          'azid': 'use2-az2',
